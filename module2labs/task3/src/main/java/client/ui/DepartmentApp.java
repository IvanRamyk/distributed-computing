...
public class DepartmentApp extends JFrame {
    ...
    private void buildProfessorDeleteForm() throws IOException, ClassNotFoundException {
        ...
        professors = client.getAllProfessors();
                ...
                e -> {
                    var th = new Thread(
                            () -> {
                                ...
                                try {
                                    client.deleteProfessorById(pId);
                                    rebuildProfessorTable();
                                    rebuildSubjectTable();
                                    contents.setVisible(true);
                        ...
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        ...
                                        client.addSubject(new Subject(-1L, name, hours, client.findProfessorById(pId)));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                    ...
                    e -> {
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        int hours = Integer.parseInt(shours);
                                        client.updateSubject(new Subject(sId, name, hours, client.findProfessorById(pId)));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                                    }
                                    try {
                        ...
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        ...
                                        client.updateProfessor(new Professor(pId, firstName, lastName, age, null));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                    ...
                    e -> {
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        int age = Integer.parseInt(sAge);
                                        client.addProfessor(new Professor(-1L, firstName, lastName, age, null));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
    ...
    private void rebuildProfessorTable() throws IOException, ClassNotFoundException {
        professorsData = professorsToStringData(client.getAllProfessors());
    ...
    private void rebuildSubjectTable() throws IOException, ClassNotFoundException {
        subjectData = subjectsToStringData(client.getAllSubjects());
    ...
    public DepartmentApp(SocketClient socketClient) throws IOException, ClassNotFoundException {
        super("Department");
        client = socketClient;
