...
public class DepartmentApp extends JFrame {
    ...
    private void buildSubjectDeleteForm() throws IOException, ClassNotFoundException {
    ...
    private void buildProfessorDeleteForm() throws IOException, ClassNotFoundException {
        ...
        professors = stub.getAllProfessors();
    ...
    private void buildSubjectBoxForm(boolean isUpdate) throws IOException, ClassNotFoundException {
                        ...
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        ...
                                        stub.addSubject(new Subject(-1L, name, hours, stub.findProfessorById(pId)));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                    ...
                    e -> {
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        int hours = Integer.parseInt(shours);
                                        stub.updateSubject(new Subject(sId, name, hours, stub.findProfessorById(pId)));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                                    }
                                    try {
    ...
    private void buildProfessorBoxForm(boolean isUpdate) throws IOException, ClassNotFoundException {
                        ...
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        ...
                                        stub.updateProfessor(new Professor(pId, firstName, lastName, age, null));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                    ...
                    e -> {
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        int age = Integer.parseInt(sAge);
                                        stub.addProfessor(new Professor(-1L, firstName, lastName, age, null));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
    ...
    private void rebuildProfessorTable() throws IOException, ClassNotFoundException {
        professorsData = professorsToStringData(stub.getAllProfessors());
    ...
    private void rebuildSubjectTable() throws IOException, ClassNotFoundException {
        subjectData = subjectsToStringData(stub.getAllSubjects());
    ...
    public DepartmentApp() throws IOException, ClassNotFoundException, NotBoundException {
        super("Department");
        registry = LocateRegistry.getRegistry(1235);
        stub = (RMIServerInterface) registry.lookup("department");
