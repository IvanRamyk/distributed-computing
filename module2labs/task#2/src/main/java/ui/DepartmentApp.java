...
public class DepartmentApp extends JFrame {
                ...
                e -> {
                    var th = new Thread(
                            () -> {
                                ...
                                try {
                                    SubjectDAO.deleteSubjectById(pId);
                ...
                e -> {
                    var th = new Thread(
                            () -> {
                                ...
                                try {
                                    ProfessorDAO.deleteProfessorById(pId);
                                    rebuildProfessorTable();
                                    rebuildSubjectTable();
                                    contents.setVisible(true);
                        ...
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        ...
                                        SubjectDAO.addSubject(name, hours, pId);
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                    ...
                    e -> {
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        int hours = Integer.parseInt(shours);
                                        SubjectDAO.updateSubject(new Subject(sId, name, hours, ProfessorDAO.findProfessorByID(pId)));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                                    }
                                    rebuildProfessorTable();
                        ...
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        ...
                                        ProfessorDAO.updateProfessor(new Professor(pId, firstName, lastName, age, null));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
                    ...
                    e -> {
                        var th = new Thread(
                                () -> {
                                    ...
                                    try {
                                        int age = Integer.parseInt(sAge);
                                        ProfessorDAO.addProfessor(new Professor(-1L, firstName, lastName, age, null));
                                    } catch (Exception exception) {
                                        exception.printStackTrace();
    ...
    private void rebuildProfessorTable() {
        professorsData = professorsToStringData(ProfessorDAO.getAllProfessors());
    ...
    private void rebuildSubjectTable() {
        subjectData = subjectsToStringData(SubjectDAO.getAllSubjects());
